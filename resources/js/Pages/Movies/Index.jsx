...
import MovieCreate from "./Create";
...
export default function MovieIndex({ auth, model, queryParams = null }) {
    ...
    const sortChanged = (name) => {
        ...
        router.get(route("movies.index"), { ...queryParams });
    };
    ...
    const confirmDelete = () => {
        ...
        router.delete(route("movies.destroy", item.id), {
            onSuccess: () => {
                toast({
                    className: cn(
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <div className="md:flex justify-between mb-6">
                                ...
                                <MovieCreate resourceName={resourceName} />
                            </div>
